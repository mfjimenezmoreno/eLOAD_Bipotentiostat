...
"""Hot to stream data, this imples that columndatasource identifies this as new data to be updated
There is an optional rollover argument if you desire to cotnain a maximum number of data"""
...
"""Interesting: x_range config to keep track of recent data!"""
